...
private:
    ...
    void                AddBlock(libMesh *buffer, float x, float y, Block::Color colorType, const libColor &color = libColor()) const;
    void                AddBorder(libMesh *buffer, const libQuad &quad, const libColor &color) const;
